...
namespace VEMS.AMathCore
{
        ...
        IEqualityOperators<GridInfo1D, GridInfo1D, bool>
    {
        ...
        /// </remarks>
        public Real Range => Count * Spacing;
        ...
        /// </remarks>
        public Real End => Start + Range - Spacing;
        ...
        /// </remarks>
        public Real LowerBound => Start - 0.5 * Spacing;
        ...
        /// </remarks>
        public Real UpperBound => Start + Range - 0.5 * Spacing;
        ...
        /// </param>
        public GridInfo1D(long n, Real spacing, Real refPoint,
        ...
        /// <param name="n">The number of grid points.</param>
        /// <param name="spacing">The spacing between grid points.</param>
        public GridInfo1D(long n, Real spacing)
        ...
        /// <returns>The coordinate value at the specified index.</returns>
        public Real GetCoordinate(long i)
            => (Start + i * Spacing);
        ...
        /// </returns>
        public Vect<Real> GetCoordinates()
            => Vect<Real>.Create(n: Count, x0: Start, dx: Spacing);
        ...
        /// </returns>
        public long FindGridSpan(ref Real x,
            bool periodic = false)
        {
            ...
            ref double cLinear)
        {
            ...
            Real spacing = 2.0 * Math.PI / Range;

            // finds the center in the conjugated domain, first
            Real center = isForward ? +cLinear : -cLinear;
        ...
        /// </param>
        public void GetModified(Real rngFactor = 1.0,
            Real spdFactor = 1.0,
            Real ctrShift = 0.0)
        {
            // updates properties
        ...
        /// </returns>
        public GridInfo1D Modify(Real rngFactor = 1.0,
            Real spdFactor = 1.0, Real ctrShift = 0.0)
        {
        ...
        /// </returns>
        public GridInfo1D Scale(Real scale,
            GridRefType refType = GridRefType.Center)
        {
            Real refPoint = refType switch
            {
        ...
        /// </returns>
        public static GridInfo1D operator *(GridInfo1D g, Real scale)
        {
        ...
        public static GridInfo1D operator *(Real scale, GridInfo1D g)
            => g * scale;
