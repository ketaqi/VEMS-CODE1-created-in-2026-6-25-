...
namespace VEMS.AMathCore
{
        ...
        IEqualityOperators<GridInfo2D, GridInfo2D, bool>
    {
        ...
        /// </summary>
        public Real RangeX => Cols * SpacingX;
        ...
        /// </summary>
        public Real RangeY => Rows * SpacingY;
        ...
        /// </summary>
        public Real EndX => StartX + RangeX - SpacingX;
        ...
        /// </summary>
        public Real EndY => StartY + RangeY - SpacingY;
        ...
        /// </summary>
        public Real LowerBoundX => StartX - 0.5 * SpacingX;
        ...
        /// </summary>
        public Real UpperBoundX => StartX + RangeX - 0.5 * SpacingX;
        ...
        /// </summary>
        public Real LowerBoundY => StartY - 0.5 * SpacingY;
        ...
        /// </summary>
        public Real UpperBoundY => StartY + RangeY - 0.5 * SpacingY;
        ...
        /// </returns>
        public (Real, Real) this[long iRow, long iCol]
        {
        ...
        /// A tuple containing the coordinates (y, x) corresponding to the specified row and column indices.
        /// </returns>
        public (Real, Real) this[int iRow, int iCol]
        {
        ...
        /// A tuple containing the coordinates (y, x) corresponding to the specified row and column indices.
        /// </returns>
        public (Real, Real) this[Index iRow, Index iCol]
        {
        ...
        public GridInfo2D(long rows, long cols,
            Real spacingY, Real spacingX,
            Real refPointY, Real refPointX,
        ...
        public Real GetCoordinateX(long iCol)
        ...
        public Real GetCoordinateY(long iRow)
        ...
        /// </returns>
        public (long, long) FindGridSpan(ref Real y, ref Real x,
        ...
        private unsafe Vect<Real> GetCoordinates(bool isAlongX)
        {
            long n = isAlongX ? Cols : Rows;
            Real start = isAlongX ? StartX : StartY;
            Real delta = isAlongX ? SpacingX : SpacingY;
            return Vect<Real>.Create(n: n, x0: start, dx: delta);
        }
        ...
        /// </returns>
        public Vect<Real> GetCoordinatesX()
        ...
        public Vect<Real> GetCoordinatesY()
        ...
        public void GetConjugated(bool isForward,
            ref Real cLinearX, ref Real cLinearY)
        {
            // number of samples remains the same
            long rows = Rows;
            long cols = Cols;
            // spacing in the conjugated domain
            Real spacingX = 2.0 * Math.PI / RangeX;
            Real spacingY = 2.0 * Math.PI / RangeY;

            // finds the center in the conjugated domain, first
            Real centerX = isForward ? cLinearX : -cLinearX;
            Real centerY = isForward ? cLinearY : -cLinearY;
        ...
        public void GetModified(Real rngFactorX = 1.0, Real rngFactorY = 1.0,
            Real spdFactorX = 1.0, Real spdFactorY = 1.0,
            Real ctrShiftX = 0.0, Real ctrShiftY = 0.0)
        {
            // updates properties
        ...
        public GridInfo2D Modify(Real rngFactorX = 1.0, Real rngFactorY = 1.0,
            Real spdFactorX = 1.0, Real spdFactorY = 1.0,
            Real ctrShiftX = 0.0, Real ctrShiftY = 0.0)
        {
            ...
            GridRefType refTypeX = GridRefType.Center)
        {
            ...
            Real refPointX = refTypeX switch
            {
        ...
        /// </returns>
        public static GridInfo2D operator *(GridInfo2D g, (Real, Real) scale)
        {
        ...
        /// but with grid spacings multiplied by the specified scaling factors and centered at the same coordinates.
        /// </returns>
        public static GridInfo2D operator *((Real, Real) scale, GridInfo2D g)
            => g * scale;
