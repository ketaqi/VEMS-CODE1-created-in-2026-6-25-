...
namespace VEMS.AMathCore
{
    ...
    public sealed unsafe class IntelMKLNative
    {
        ...
        internal static extern SPARSE_Status mkl_sparse_z_set_value_64(
            IntPtr A, long row, long col, Cplx value);
        ...
        internal static extern void PARDISO_64(void* pt,
            long* maxfct, long* mnum, long* mtype, long* phase,
            long* n, void* a, long* ia, long* ja,
            long* perm, long* nrhs, long* iparm, long* msglvl,
            void* b, void* x, long* error);
        ...
        internal static extern void dfgmres_init(long* n, 
            double* x, double* b, long* RCI_request, 
            long* ipar, double* dpar, double* tmp);


        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true, SetLastError = false)]
        // Checks consistency and correctness of
        // the user defined data.
        internal static extern void dfgmres_check(long* n,
            double* x, double* b, long* RCI_request, 
            long* ipar, double* dpar, double* tmp);
        ...
        internal static extern void dfgmres(long* n,
            double* x, double* b, long* RCI_request,
            long* ipar, double* dpar, double* tmp);
        ...
        internal static extern void dfgmres_get(long* n,
            double* x, double* b, long* RCI_request,
            long* ipar, double* dpar, double* tmp,
            long* itercount);
