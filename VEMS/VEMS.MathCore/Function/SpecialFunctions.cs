...
namespace VEMS.MathCore
{
    ...
    public static partial class SpecialFunctions
    {
        ...
        // reference: 
        // https://github.com/scipy/scipy/blob/master/scipy/special/amos_wrappers.c
        static class Amos
        {
            #region AiryAi
        ...
        // Translated from AMOS fortran codes
        // References:
        ...
        public static double AiryAiPrime(double z)
            => AiryAiPrime(new Complex(z, 0)).Real;
        ...
        public static double AiryBiScaled(double z)
            => AiryBiScaled(new Complex(z, 0)).Real;
        ...
        public static double AiryBiPrime(double z)
            => AiryBiPrime(new Complex(z, 0)).Real;
        ...
        public static double AiryBiPrimeScaled(double z)
            => AiryBiPrimeScaled(new Complex(z, 0)).Real;
        ...
        public static double BesselI(double n, double z)
            => BesselI(n, new Complex(z, 0)).Real;
