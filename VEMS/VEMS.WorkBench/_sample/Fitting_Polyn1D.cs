...
var us = new VectorD(count: usCount, initVal: start, increment: (end - start) / (usCount - 1));
var ys = VMath.Sin(us); 


// polynomial class construction
var fitter = new Polyn1D(xs: us, ys: ys,
    degree: 23,
    checkFitError: false);
...
// derivative
var dy = fitter.Derivative(evaGrid.GetCoordinates());
...
// show
VFrame.SetFrameParameters(f: fig, title: "Polynomial Fitting", xLabel: "x", yLabel: "y");
