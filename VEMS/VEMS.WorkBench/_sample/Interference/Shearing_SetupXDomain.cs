...
var na = 0.1; // numerical aperture
var dist = 7.5E-3; // point distance
var focalShift = 0.1E-3; // shift from actual focal plane
var p = 10.0E-6; // grating period
var sourceEdge = 25.0E-6;
var gratingEdge = 1.0E-6;
// sampling parameters
var wx = 3.6E-3; var wy = 1.8E-3; // window sizes
var nx = 5001; var ny = 2501; // number of samples
...
//FreeSpace.RayleighSommerfeld2D(v: ref v, distance: dist - focalShift, loopMode: LoopMode.Parallel);
v.SwitchToXDomain();
sw.Stop();
