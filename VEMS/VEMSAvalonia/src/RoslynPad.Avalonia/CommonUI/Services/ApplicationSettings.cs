...
internal class ApplicationSettings : IApplicationSettings
{
    ...
    private class SerializableValues : NotificationObject, IApplicationSettingsValues
    {
        ...
        private string _editorFontFamily1 = GetDefaultPlatformFontFamily();
        private string _editorFontFamily = GetDefaultPlatformFontFamily();
        private int _editorFontSize = DefaultFontSize;
        private int _outputFontSize = DefaultFontSize;
        ...
        public void LoadDefaultSettings()
        {
            ...
            EditorFontFamily1 = GetDefaultPlatformFontFamily();
        }
        ...
        public string EditorFontFamily1
        {
            ...
            set => SetProperty(ref _editorFontFamily1, value);
        }
