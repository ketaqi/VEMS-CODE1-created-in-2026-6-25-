...
public partial class FeatureDemoView3 : UserControl
{
    public ICommand ShowManagedNotificationCommand { get; }

    public WindowNotificationManager? NotificationManager { get; set; }

    public FeatureDemoView3()
    {
        InitializeComponent();
        ...
        //{
            ...
            //MyPropertyGrid3.LayoutUpdated += (_, _) => ScheduleApplyExpanderHeaderFix();
        //};
    }
...
#pragma warning restore CA1305
    ...
    private void ScheduleApplyExpanderHeaderFix()
    {
        ...
        Dispatcher.UIThread.Post(() =>
        {
            try
            {
                ApplyExpanderHeaderFixToPropertyGrid(MyPropertyGrid3);
            }
            finally
            {
                _applyScheduled = false;
