...
public partial class FeatureDemoView4 : UserControl
{
    ...
    public FeatureDemoView4()
    {
        ...
        //{
            ...
            //MyPropertyGrid4.LayoutUpdated += (_, _) => ScheduleApplyExpanderHeaderFix();
        //};
...
#pragma warning restore CA1305
    ...
    private void ScheduleApplyExpanderHeaderFix()
    {
        ...
        Dispatcher.UIThread.Post(() =>
        {
            try
            {
                ApplyExpanderHeaderFixToPropertyGrid(MyPropertyGrid4);
            }
            finally
            {
                _applyScheduled = false;
