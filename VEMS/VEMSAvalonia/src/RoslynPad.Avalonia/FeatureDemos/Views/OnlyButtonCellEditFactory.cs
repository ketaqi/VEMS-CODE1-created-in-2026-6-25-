...
{
    internal class OnlyButtonCellEditFactory : AbstractCellEditFactory
    {
        // 可空，允许延迟注入
        ...
        public override Control? HandleNewProperty(PropertyCellContext context)
        {
            ...
            if (context.Property.Name != nameof(SimpleObject2.Quantity))
                return null;
            ...
            button.Click += (_, _) =>
            {
                ...
                MainWindow?.TestMatrixMultiplyCommand?.Execute(null);
