...
{
    internal class OnlyButtonCellEditFactory1 : AbstractCellEditFactory
    {
        // 可空，允许延迟注入
        ...
        public override Control? HandleNewProperty(PropertyCellContext context)
        {
            ...
            if (context.Property.Name != nameof(SimpleObject2.Quantity1))
                return null;
            ...
            button.Click += (_, _) =>
            {
                ...
                MainWindow?.TestMatrixMultiplyCommand1?.Execute(null);
