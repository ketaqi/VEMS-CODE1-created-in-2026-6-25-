...
{
    internal class OnlyButtonCellEditFactory2: AbstractCellEditFactory
    {
        // 可空，允许延迟注入
        ...
        public override Control? HandleNewProperty(PropertyCellContext context)
        {
            ...
            if (context.Property.Name != nameof(SimpleObject2.Quantity2))
                return null;
            ...
            button.Click += (_, _) =>
            {
                ...
                MainWindow?.TestMatrixMultiplyCommand2?.Execute(null);
