...
{
    internal class OnlyButtonCellEditFactory3 : AbstractCellEditFactory
    {
        // 可空，允许延迟注入
        ...
        public override Control? HandleNewProperty(PropertyCellContext context)
        {
            ...
            if (context.Property.Name != nameof(SimpleObject2.Quantity3))
                return null;
            ...
            button.Click += (_, _) =>
            {
                ...
                MainWindow?.TestMatrixMultiplyCommand3?.Execute(null);
