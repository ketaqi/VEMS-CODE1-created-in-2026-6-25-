...
{
    internal class OnlyButtonCellEditFactory4 : AbstractCellEditFactory
    {
        // 可空，允许延迟注入
        ...
        public override Control? HandleNewProperty(PropertyCellContext context)
        {
            ...
            if (context.Property.Name != nameof(SimpleObject2.Quantity4))
                return null;
            ...
            button.Click += (_, _) =>
            {
                ...
                MainWindow?.TestMatrixMultiplyCommand4?.Execute(null);
