...
{
    internal class OnlyButtonCellEditFactory6 : AbstractCellEditFactory
    {
        // 可空，允许延迟注入
        ...
        public override Control? HandleNewProperty(PropertyCellContext context)
        {
            ...
            if (context.Property.Name != nameof(SimpleObject4.Quantity6))
                return null;
            ...
            button.Click += (_, _) =>
            {
                ...
                MainWindow?.CurrentOpenDocument?.TerminateCommand?.Execute(null);
