...
{
    internal class OnlyButtonCellEditFactory9 : AbstractCellEditFactory
    {
        // 可空，允许延迟注入
        ...
        public override Control? HandleNewProperty(PropertyCellContext context)
        {
            ...
            if (context.Property.Name != nameof(SimpleObject3.leftMenuItem67))
                return null;
            ...
            button.Click += (_, _) =>
            {
                MainWindow?.ImportDllButton_Click();
                Console.WriteLine(MainWindow?.CurrentOpenDocument?.NuGet.SearchTerm);
