...
{
    /// <summary>
    /// <see cref="FontAwesomeIconKey"/> 的分部类，包含旧版图标名称到 v6 的映射。
    /// </summary>
    internal partial class FontAwesomeIconKey
    {
        /// <summary>
        /// 旧版 Font Awesome 图标名称到 v6 名称的映射字典。
        /// </summary>
        /// <remarks>
        /// <para>
        /// Font Awesome v6 对许多图标进行了重命名以提高一致性和可读性。
        /// 此字典提供从旧版名称到新名称的自动转换，确保向后兼容性。
        /// </para>
        /// <para>
        /// 例如：<c>"home"</c> → <c>"house"</c>，<c>"cog"</c> → <c>"gear"</c>。
        /// </para>
        /// </remarks>
        ...
        /// <summary>
        /// 将旧版图标名称转换为 Font Awesome v6 名称。
        /// </summary>
        /// <param name="value">图标名称。</param>
        /// <returns>
        /// 若存在 v6 映射则返回新名称；否则返回原始名称。
        /// </returns>
