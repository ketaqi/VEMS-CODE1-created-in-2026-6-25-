...
public abstract class MainViewModel : NotificationObject, IDisposable
{
        ...
        )
    {
        ...
        //TestMatrixMultiplyCommand = _commands.Create(ExecuteTestMatrixMultiply);

        //TestMatrixMultiplyCommand1 = _commands.Create(ExecuteTestMatrixMultiply1);

        //TestMatrixMultiplyCommand2 = _commands.Create(ExecuteTestMatrixMultiply2);

        //TestMatrixMultiplyCommand3 = _commands.Create(ExecuteTestMatrixMultiply3);

        //TestMatrixMultiplyCommand4 = _commands.Create(ExecuteTestMatrixMultiply4);

        //（构造函数未完，后续还有：测试命令等；下一段继续）
    ...
    //public  ExecutionPlatform? Platform1
    //{
    //    get => CurrentOpenDocument?.Platform;
    //    set
    //    {
    ...
    /// <summary>
    /// 5 个性能测试相关函数（旧版注释示例；此处保留原有注释与代码结构）。
    /// </summary>
    /// <remarks>
    /// 下方为保留的注释代码块，用于记录早期的测试流程（未启用复数模式的版本）。为了保持原始工程的可追溯性与便于后续对比，
    /// 按你的要求不删除、也不改动其内容，仅在合适位置补充 XML 注释。
    /// </remarks>
    //public void ExecuteTestMatrixMultiply4()
    //{
    ...
    //    {
    //        Console.WriteLine($"Running test for matrix size {size}x{size} ...");
    //        var (avg, min, max) = TestFft(size);
    //        results.Add((size, avg, min, max));
    //    }

    //    // 打印汇总表格
    //    Console.WriteLine();
    //    Console.WriteLine("Matrix Size\t||\tAVG [ms]\t||\tMIN [ms]\t||\tMAX [ms]");
    //    foreach (var r in results)
    //    {
    //        Console.WriteLine($"[{r.size}x{r.size}]\t||\t{r.avg:F10}\t||\t{r.min:F10}\t||\t{r.max:F10}");
    //    }
    //}//TestFft FFT（快速傅里叶变换）性能测试
    //public void ExecuteTestMatrixMultiply3()
    //{
    //    int[] sizes = { 101, 201, 501, 1001, 2001 };
    //    var results = new List<(int size, double avg, double min, double max)>();
    ...
    //    {
    //        Console.WriteLine($"Running test for matrix size {size}x{size} ...");
    //        var (avg, min, max) = TestEigen(size);
    //        results.Add((size, avg, min, max));
    //    }
    ...
    //        Console.WriteLine($"[{r.size}x{r.size}]\t||\t{r.avg:F10}\t||\t{r.min:F10}\t||\t{r.max:F10}");
    //    }
    //}//TestEigen 特征值分解（Eigen）性能测试
    //public void ExecuteTestMatrixMultiply2()
    //{
    //    int[] sizes = { 101, 201, 501, 1001, 2001 };
    //    var results = new List<(int size, double avg, double min, double max)>();
    ...
    //        Console.WriteLine($"[{r.size}x{r.size}]\t||\t{r.avg:F10}\t||\t{r.min:F10}\t||\t{r.max:F10}");
    //    }
    //}//TestSvd SVD（奇异值分解）性能测试
    //public void ExecuteTestMatrixMultiply1()
    //{
    //    int[] sizes = { 101, 201, 501, 1001, 2001 };
    //    var results = new List<(int size, double avg, double min, double max)>();
    ...
    //    {
    //        Console.WriteLine($"Running test for matrix size {size}x{size} ...");
    //        var (avg, min, max) = TestLinearSystemSolve(size);
    //        results.Add((size, avg, min, max));
    //    }
    ...
    //        Console.WriteLine($"[{r.size}x{r.size}]\t||\t{r.avg:F10}\t||\t{r.min:F10}\t||\t{r.max:F10}");
    //    }
    //}//TestLinearSystemSolve 线性方程组求解性能测试
    //private (double avg, double min, double max) TestFft(int size)
    //{
    //    // 生成复数样本
    //    var samples = new MathNet.Numerics.Complex32[size];
    //    var rand = new Random();
    //    for (int i = 0; i < size; i++)
    //    {
    //        // 只用实部，虚部为0
    //        samples[i] = new MathNet.Numerics.Complex32((float)rand.NextDouble(), 0f);
    //    }
    ...
    //    {
    //        var data = (MathNet.Numerics.Complex32[])samples.Clone(); // 每次都用新数组
    ...
    //        max = Math.Max(max, ms);
    //        sum += ms;
    //        Console.WriteLine($"------- Eigen Run #{i} -------");
    //    }
    //    Console.WriteLine($"Eigen: [Average] {sum / runs} [ms]; [Minimum] {min} [ms]; [Maximum] {max} [ms].");
    //    return (sum / runs, min, max);
    //}
    //private (double avg, double min, double max) TestSvd(int size)
    //{
    //    var matrixA = Matrix<double>.Build.Random(size, size);
    ...
    //        max = Math.Max(max, ms);
    //        sum += ms;
    //        Console.WriteLine($"------- SVD Run #{i} -------");
    //    }
    //    Console.WriteLine($"SVD: [Average] {sum / runs} [ms]; [Minimum] {min} [ms]; [Maximum] {max} [ms].");
    //    return (sum / runs, min, max);
    //}
    //private (double avg, double min, double max) TestLinearSystemSolve(int size)
    //{
    //    var matrixA = Matrix<double>.Build.Random(size, size);
    //    var vectorB = Vector<double>.Build.Random(size);
    ...
    //    {
    //        var sw = Stopwatch.StartNew();
    //        var x = matrixA.Solve(vectorB);
    //        sw.Stop();
    //        double ms = sw.Elapsed.TotalMilliseconds;
    //        min = Math.Min(min, ms);
    //        max = Math.Max(max, ms);
    //        sum += ms;
    //        Console.WriteLine($"------- Linear Solve Run #{i} -------");
    //    }
    //    Console.WriteLine($"Linear Solve: [Average] {sum / runs} [ms]; [Minimum] {min} [ms]; [Maximum] {max} [ms].");
    //    return (sum / runs, min, max);
    //}
    ////public ICommand TestMatrixMultiplyCommand { get; }
    ////public ICommand TestMatrixMultiplyCommand1 { get; }
    ////public ICommand TestMatrixMultiplyCommand2 { get; }
    ////public ICommand TestMatrixMultiplyCommand3 { get; }
    ////public ICommand TestMatrixMultiplyCommand4 { get; }
    //public void ExecuteTestMatrixMultiply()
    //{
    //    int[] sizes = { 101, 201, 501, 1001, 2001 };
    //    var results = new List<(int size, double avg, double min, double max)>();
    ...
    //    {
    //        Console.WriteLine($"Running test for matrix size {size}x{size} ...");
    //        var (avg, min, max) = TestMatrixMultiply(size);
    //        results.Add((size, avg, min, max));
    //    }
    ...
    //        Console.WriteLine($"[{r.size}x{r.size}]\t||\t{r.avg:F10}\t||\t{r.min:F10}\t||\t{r.max:F10}");
    //    }
    //}//TestMatrixMultiply 矩阵乘法性能测试
    //private (double avg, double min, double max) TestMatrixMultiply(int size)
    //{
    //    var matrixA = Matrix<double>.Build.Random(size, size);
    ...
    /// 触发“矩阵乘法”性能测试的命令。
    /// </summary>
    public ICommand TestMatrixMultiplyCommand => _commands.Create(ExecuteTestMatrixMultiply);

    /// <summary>
    /// 触发“线性方程组求解”性能测试的命令。
    /// </summary>
    public ICommand TestMatrixMultiplyCommand1 => _commands.Create(ExecuteTestMatrixMultiply1);

    /// <summary>
    /// 触发“SVD（奇异值分解）”性能测试的命令。
    /// </summary>
    public ICommand TestMatrixMultiplyCommand2 => _commands.Create(ExecuteTestMatrixMultiply2);

    /// <summary>
    /// 触发“特征值分解（Eigen/EVD）”性能测试的命令。
    /// </summary>
    public ICommand TestMatrixMultiplyCommand3 => _commands.Create(ExecuteTestMatrixMultiply3);

    /// <summary>
    /// 触发“FFT（快速傅里叶变换）”性能测试的命令。
    /// </summary>
    public ICommand TestMatrixMultiplyCommand4 => _commands.Create(ExecuteTestMatrixMultiply4);
    ...
    public void ExecuteTestMatrixMultiply()
    {
        ...
        foreach (var size in sizes)
        {
            Console.WriteLine($"Running test for matrix size {size}x{size} ... IsComplex={IsComplexMatrixMultiplyEnabled}");
            // 统一入口：根据 IsComplexMatrixMultiplyEnabled 与 TestRunCount 选择复数/实数并重复 runs 次
            var (avg, min, max) = TestMatrixMultiply(size, IsComplexMatrixMultiplyEnabled, TestRunCount);
            results.Add((size, avg, min, max));
        }
    ...
    public void ExecuteTestMatrixMultiply1()
    {
        ...
        foreach (var size in sizes)
        {
            Console.WriteLine($"Running test for matrix size {size}x{size} ... IsComplex={IsComplexLinearSolveEnabled}");
            var (avg, min, max) = TestLinearSystemSolve(size, IsComplexLinearSolveEnabled, TestRunCount);
            results.Add((size, avg, min, max));
        }
    ...
    public void ExecuteTestMatrixMultiply2()
    {
        ...
        foreach (var size in sizes)
        {
            Console.WriteLine($"Running test for matrix size {size}x{size} ... IsComplex={IsComplexSvdEnabled}");
            var (avg, min, max) = TestSvd(size, IsComplexSvdEnabled, TestRunCount);
            results.Add((size, avg, min, max));
        }
    ...
    public void ExecuteTestMatrixMultiply3()
    {
        ...
        foreach (var size in sizes)
        {
            Console.WriteLine($"Running test for matrix size {size}x{size} ... IsComplex={IsComplexEigenEnabled}");
            var (avg, min, max) = TestEigen(size, IsComplexEigenEnabled, TestRunCount);
            results.Add((size, avg, min, max));
        }
    ...
    public void ExecuteTestMatrixMultiply4()
    {
        ...
        foreach (var size in sizes)
        {
            Console.WriteLine($"Running test for matrix size {size}x{size} ... IsComplex={IsComplexFftEnabled}");
            var (avg, min, max) = TestFft(size, IsComplexFftEnabled, TestRunCount);
            results.Add((size, avg, min, max));
        }
    ...
    private (double avg, double min, double max) TestSvd(int size, bool complex, int runs)
    {
        ...
        if (complex)
        {
            var matrixA = MathNet.Numerics.LinearAlgebra.Matrix<System.Numerics.Complex>.Build.Random(size, size);
            for (int i = 0; i < runs; i++)
            {
                var sw = Stopwatch.StartNew();
        ...
        {
            var matrixA = MathNet.Numerics.LinearAlgebra.Matrix<double>.Build.Random(size, size);
            for (int i = 0; i < runs; i++)
            {
                var sw = Stopwatch.StartNew();
    ...
    private (double avg, double min, double max) TestFft(int size, bool complex, int runs)
    {
        ...
        {
            // 复数样本：实部/虚部均随机
            var samples = new System.Numerics.Complex[size];
            var rand = new Random();
            for (int i = 0; i < size; i++)
            {
                samples[i] = new System.Numerics.Complex(rand.NextDouble(), rand.NextDouble());
            }
            for (int i = 0; i < runs; i++)
            {
                var data = (System.Numerics.Complex[])samples.Clone(); // 防止就地变换污染原数组
                var sw = Stopwatch.StartNew();
        ...
        else
        {
            ...
            for (int i = 0; i < runs; i++)
            {
                var data = (MathNet.Numerics.Complex32[])samples.Clone(); // 防止就地变换污染原数组
                var sw = Stopwatch.StartNew();
                MathNet.Numerics.IntegralTransforms.Fourier.Forward(data, MathNet.Numerics.IntegralTransforms.FourierOptions.Default);
                sw.Stop();
                double ms = sw.Elapsed.TotalMilliseconds;
    ...
    private void OpenSearchPanel()
    {
        ...
        {
            // 可选：把错误写到结果区，避免静默失败
            CurrentOpenDocument?.AddResult(new ResultObject
            {
                Header = "[Search]",
                Value = "没有可用的编辑器实例（可能未打开文档）。",
                Type = "Info",
                LineNumber = null
            });
            return;
    ...
    /// <see cref="FolderPathInputWithCount"/>（若你有该属性）。
    /// </remarks>
    ...
    {
        if (CurrentOpenDocument?.CopyAllResultsCommand.CanExecute() == true)
        {
            CurrentOpenDocument.CopyAllResultsCommand.Execute();
            Console.WriteLine("[MainViewModel] CopyAllResultsCommand 已执行");
        }
        else
        {
            Console.WriteLine("[MainViewModel] CopyAllResultsCommand 不可执行");
        }
    }
    ...
    public DocumentViewModel? SelectedDocument
    {
        ...
        set
        {
            ...
            if (value is not null)
            {
                ...
                {
                    value.Rename(System.IO.Path.GetFileName(value.Path));
                }
    ...
    private async Task LoadPreviewAsync(DocumentViewModel? doc)
    {
        ...
        try
        {
                ...
                options: FileOptions.Asynchronous | FileOptions.SequentialScan))
            {
                ...
                buffer = new byte[len];
                int read = await fs.ReadAsync(buffer.AsMemory(0, len), ct).ConfigureAwait(false); // CA1835
    ...
    private void AboutVEMS()
    {
        ...
        if (CurrentOpenDocument != null)
        {
            ...
            CurrentOpenDocument.AddResult(result1);
            ...
            CurrentOpenDocument.AddResult(result2);
        }
    }
    ...
    private void Contact()
    {
        ...
        if (CurrentOpenDocument != null)
        {
            ...
            CurrentOpenDocument.AddResult(result);
        }
    }
    ...
    /// </summary>
    /// <remarks>
    /// 通过 <see cref="Task.Run(System.Action)"/> 在后台线程启动默认浏览器打开链接；
    ...
    public async Task CloseDocument(OpenDocumentViewModel? document)
    {
        ...
        bool isDirty = document.IsDirty; // 如无此属性请替换为实际判断
        // 已存在且有变化
        if (isDirty)
        {
    ...
    private void CycleTheme()
    {
        ...
        BuiltInTheme nextTheme = currentTheme switch
        {
    ...
    /// <summary>
    /// 校验快捷键字符串是否合法（使用 Avalonia 的 <see cref="KeyGesture.Parse(string)"/> 解析）。
    /// </summary>
    /// <param name="shortcut">待校验的快捷键字符串（如“Ctrl+O”）。</param>
    /// <returns>可成功解析则返回 <c>true</c>，否则 <c>false</c>。</returns>
    public static bool IsValidShortcut(string shortcut)
    {
        try
        {
            KeyGesture.Parse(shortcut);
            return true;
        }
        catch
        {
    ...
    public string SaveAllShortcut
    {
        ...
        set
        {
            if (_saveAllShortcut != value)
            {
                ...
                OnPropertyChanged(nameof(ExitAppTip)); SaveShortcuts(); LoadShortcuts();
            }
        }
    }
    ...
    /// </summary>
    private string _initialLanguage = "zh-CN";
