...
/// <summary>
/// VS Code 颜色注册表，提供编辑器 UI 元素的默认颜色定义。
/// </summary>
/// <remarks>
/// 该类注册了所有 VS Code 编辑器支持的颜色标识符及其在亮色/暗色主题下的默认值，
/// 包括编辑器背景、前景、选择高亮、小部件、列表、选项卡、面板、状态栏等 UI 元素的颜色。
/// </remarks>
internal class VsCodeColorRegistry : IColorRegistry
{
    ...
    /// <summary>
    /// 初始化 <see cref="VsCodeColorRegistry"/> 类的新实例，并注册所有默认颜色。
    /// </summary>
