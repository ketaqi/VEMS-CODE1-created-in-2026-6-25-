...
VFrame.CreateShow(values: VMath.Abs(vIn),
    title: "Input |E| Field",
...
VFrame.CreateShow(values: VMath.Abs(vOut),
    title: $"Output |E| Field (z=675um, {sw.Elapsed.TotalMilliseconds:F1}ms)",
    xLabel: "x [um]", yLabel: "|E| [A.U.]",
    grid: det.GridInfo * 1E3);

// Phase
var vPhase = det.Sample(v: v, quantity: DetectQuantity.Phase);
VFrame.CreateShow(values: vPhase,
    title: "Output Phase",
    xLabel: "x [um]", yLabel: "Phase [rad]",
    grid: det.GridInfo * 1E3);
